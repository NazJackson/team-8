...
function ($scope, $http, $stateParams) {
 $scope.submit = function(data){
   var username = document.getElementById('signUp-input5');
   var password = document.getElementById('signUp-input6');
   var zipcode =document.getElementById('signUp-input7')
   alert("Thanks for Signing up with United WAY!");
   var dataObj = {
     username : username.value,
     password: password.value,
     zipcode : zipcode.value
   };
   $http.post("http://localhost:8080/signup", dataObj)
   .then(
     function(response){
       console.log(response);
     },
